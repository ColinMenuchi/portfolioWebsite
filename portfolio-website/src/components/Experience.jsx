...
const Experience = () => {
  ...
  return (
    <section id="experience" className="experience-section">
      ...
      <p className="experience-subheading">If you would like to see my resume for more information on everything in this timeline, please feel free to contact me!</p>
